...
# write.csv(h3n2_singleHA_wildtype,file="./toydata_result/BethH3_HAonly_wildtype_HA.csv",row.names = F)
# write.csv(h3n2_singleNA_wildtype,file="./toydata_result/BethH3_NAonly_wildtype_NA.csv",row.names = F)
